...
import './FDressPost.css'
import img from '../../../../Asset/1.jpg'
import AdminLayout from '../../../../Component/AdminLayout/AdminLayout'

function AdminFDressPost() {
  return (
    <AdminLayout>
      <div className='admin_fdress_post'>
        <div>
            <div className='admin_fdress_post_img'>
                {/* <div> */}
                <div>
                    {/* <p><img src={img} width={270}/></p> */}
                    <div>
                        <p><img src={img} width={250}/></p>
                        <p><input  type='file'/></p>
                    </div>
                </div>
            ...
            <h2>Post</h2>
            <div className='admin_fdress_post_info'>
                <div>
                    <h3>Name</h3>
            ...
            <div className='admin_fdress_post_submit_btn'>
                <h3>Submit</h3>
            </div>
        </div>
    </div>
...
export default AdminFDressPost