...
import './FDressUpdate.css'
import AdminLayout from '../../../../Component/AdminLayout/AdminLayout'
import img from '../../../../Asset/1.jpg'

function AdminFDressUpdate() {
  return (
    <AdminLayout>
      <div className='admin_fdress_update'>
        <div>
            <div className='admin_fdress_update_img'>
                {/* <div> */}
                <div>
            ...
            <h2>update</h2>
            <div className='admin_fdress_update_info'>
                <div>
                    <h3>Name</h3>
            ...
            <div className='admin_fdress_update_submit_btn'>
                <h3>Submit</h3>
            </div>
        </div>
    </div>
...
export default AdminFDressUpdate