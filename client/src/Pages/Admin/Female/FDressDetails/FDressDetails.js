...
import './FDressDetails.css'
import img from '../../../../Asset/1.jpg'
import AdminLayout from '../../../../Component/AdminLayout/AdminLayout'

function AdminFDressDetails() {
  return (
    <AdminLayout>
    <div className='admin_fdress_details'>
        <div>
            <div className='admin_fdress_details_img'>
                {/* <div> */}
                <div>
            ...
            <h2>Details</h2>
            <div className='admin_fdress_details_info'>
                <div>
                    <h3>Name</h3>
            ...
            <div className='admin_fdress_details_submit_btn'>
                <h3>Submit</h3>
            </div>
        </div>
    </div>
...
export default AdminFDressDetails